...
const highlights = [
  {
    icon: GraduationCap,
    title: "Education",
    value: "M.Sc. Industrial Engineering",
    detail: "Beykent University, Istanbul",
    extra: "Sep 2026 - Present",
  },
  {
    icon: Award,
    title: "Scholarship",
      ...
      <div ref={ref} className="max-w-5xl mx-auto">
        ...
        >
          ...
          <p className="text-pretty">
            ...
            . I have a strong interest in workflow automation, API
            integration, and emerging AI technologies.
          </p>
          ...
          <p className="text-pretty">
            ...
            technical background, gain practical industry experience, and
