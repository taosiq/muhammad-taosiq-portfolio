...
export function Hero() {
  ...
  return (
    <section id="home" className="min-h-screen flex flex-col justify-center px-6 md:px-12 lg:px-24 pt-20 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto w-full">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-12 items-center">
          <div className="order-2 lg:order-1">
            ...
            >
              I build accessible, pixel-perfect digital experiences for the web. Specializing in{" "}
              <span className="text-foreground font-medium">AI & Deep Learning</span>,{" "}
            ...
            >
              Graduate from{" "}
              <span className="text-foreground">NUST, Pakistan</span>. Seeking opportunities for{" "}
              <span className="text-primary font-medium">Master&apos;s programs abroad</span>,{" "}
              remote positions, or international collaborations.
            </p>
